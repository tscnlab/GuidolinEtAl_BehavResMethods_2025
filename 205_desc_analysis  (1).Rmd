...
Plot <- dataset.LL.partial %>% aggregate_Datetime2(unit = "5 mins")  %>% 
  gg_day(facetting = FALSE, geom = "ribbon", alpha = 0.25, size = 0.25,
         fill = "#EFC000", color = "#EFC000", x.axis.label = "Time of day", title = "Example of continuous personal and environmental light exposure over a week", y.axis.label = "Illuminance (mEDI) [lux]") + #base plot
  solar.reference + brown.reference + scale.correction

```

```{r}
Plot_nobrown <- dataset.LL.partial %>% aggregate_Datetime2(unit = "5 mins")  %>% 
  gg_day(facetting = FALSE, geom = "ribbon", alpha = 0.25, size = 0.25,
         fill = "#EFC000", color = "#EFC000", x.axis.label = "Time of day", title = "Example of continuous personal and environmental light exposure over a week", y.axis.label = "Illuminance (mEDI) [lux]") + #base plot
  solar.reference ++ scale.correction
...
Brown.times_2 <- Brown.times[15:17,]
x <- 900
