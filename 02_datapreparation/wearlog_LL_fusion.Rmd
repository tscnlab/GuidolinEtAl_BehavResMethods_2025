...
# Note: run this script after cleaning the data! 
This means you should run this script after running wearlog_qualitychecks.Rmd. 
...
dataset.LL.wrlg <- dataset.LL.all %>% 
  ...
  LightLogR::interval2state(wrlg_int, State.colname = bag)
```

## Optional: Saving the file as RDS
```{r}
saveRDS(dataset.LL.wrlg, file = "G:/cyepi/code/pre-processing/nonwear_detection/clean_data.rds")
```
