...
y_limits <- as.POSIXct(c("1970-01-01 8:30", "1970-01-01 16:30"), tz = "UTC")
...
```{r}
ggsave(plot = chronoscatter, filename = "chronotype_scattersingle.png", width = 7, height = 7, dpi = 600, bg = "white", path = "C:/Users/guido/Desktop/cyepi/code/outputs")
```
...
```{r}
y_limits2 <- as.POSIXct(c("1970-01-01 08:00", "1970-01-01 16:30"), tz = "UTC")
...
```{r}
ggsave(plot = chrono_violin, filename = "chronotype_violinsingle.png", width = 7, height = 7, dpi = 600, bg = "white", path = "C:/Users/guido/Desktop/cyepi/code/outputs")
```
...
ggsave(plot = chrono_multiplot, filename = "chronotype_all.png", width = 7, height = 5, dpi = 600, bg = "white", path = "C:/Users/guido/Desktop/cyepi/code/outputs")
```
