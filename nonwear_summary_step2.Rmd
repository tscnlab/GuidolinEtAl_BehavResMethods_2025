...
Let's save this
```{r}
ggsave(plot = summary_plot_all, filename ="summaryplot7.png", dpi =300, width = 9, height = 6)
```
...
Let's save this 
```{r}
ggsave(plot = faceted_plot_wearlog2, filename ="faceted_plotA.png", dpi =300, width = 12, height = 14)
```
