...
1) Incorporates the bag information into the same dataframe. However, this must be revisited: we have now changed some entries in the wearlog files, e.g. we have deleted some entries or altered them (changed an on entry to an off entry). How to adjust the bag entries based on these changes?
