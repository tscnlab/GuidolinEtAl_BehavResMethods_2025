...
precision_recall_curve <- ggplot() +
  ...
  #Adding the arrow to show directionality
  ...
  #Adding the arrow to show directionality
  geom_segment(aes(x = 0.49, y = 0.165, xend = 0.57, yend = 0.125),
               arrow = arrow(length=unit(.2, "cm")), lwd = 0.8) +
  ...
  annotate("text", x = 0.64, y = 0.45, label = sprintf('\u2191')) +
  geom_text(aes(x= 0.80, y = 0.445, label = "Illuminance")) +
  annotate("text", x = 0.28, y = 0.14, label = sprintf('\u2191')) +
  geom_text(aes(x = 0.39, y = 0.135, label = "Activity")) +
  theme_bw() +
...
#Save the plot
ggsave(filename = "precision_recall_curve.png",
