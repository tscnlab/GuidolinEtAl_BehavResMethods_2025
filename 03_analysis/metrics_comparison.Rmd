...
clean_wrlg <- ggpubr::ggscatter(data = is_all,
  ...
  theme(plot.margin = unit(c(t=0,r=0.2,b=0.2,l=0), "cm"))
...
p3 <- raw_vs_wrlg_vis + raw_vs_clusters_vis + delta_hist +
  patchwork::plot_annotation("MLiT 10 lx",
...
plots1 <- plot_grid(p1,p2,p4, p5, p6, p7,
                   align = "v",
                   nrow = 6)

plots2 <- plot_grid(p8, p9, p10, p11, p12, p13,
                   align = "v",
                   nrow = 6)
