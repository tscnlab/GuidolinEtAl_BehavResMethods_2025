...
#Save the plot
ggsave(filename = "precision-recall-10mins.png",
       plot = prc_combined,
       height = 5.5, 
       width = 5,
       dpi = 600,
...
#Not sure about wrapping this into a function actually
medithresholds <- seq(1, 10, by = 1)
...
#Turn the list with the results into a df 
prc_medi_df <- bind_rows(prc_medi_list)

#Turn thresholds from character to factor for plotting
prc_medi_df$threshold <- as.numeric(prc_medi_df$threshold)
