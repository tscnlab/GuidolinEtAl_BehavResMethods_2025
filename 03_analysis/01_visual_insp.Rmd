...
ggsave(filename = filename,
       ...
       dpi = 600,
       bg = "white",
       path = here::here("outputs", "visual_insp")) # choose saving location!
}
...
ggsave(filename = filename,
       ...
       dpi = 600,
       bg = "white",
       path= here::here("outputs", "visual_insp")) # choose where to save (relative path)
}
...
ggsave(filename = "results_fig04.png",
       plot = p,
       width = 11,
       height = 14,
       dpi = 600,
       bg = "white",
       path= here::here("outputs", "fig04"))
