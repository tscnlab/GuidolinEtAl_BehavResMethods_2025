...
# Combining the dfs 
temp <- dplyr::full_join(is_raw_dataset, is_nw_wrlg, by = "Id") #first, combine raw and wrlg data sets
is_all <- dplyr::full_join(temp, is_nw_clusters, by = "Id") #second, add clusters data set
